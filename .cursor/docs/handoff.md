...
### F. 次回（6/22月）チェック観点
- **6/22(月)朝便の must_follow / total**（日曜要因か恒常縮小かの切り分け。非ゼロ・前日比で回復するか）。急減検知のfull履歴が積み上がる。
...
| 2 | （本記録） | ops: daily_check.py に must_follow急減検知を追加（full便のみ比較・履歴ゲート・テスト+4＝全105件green）＝改善A |
