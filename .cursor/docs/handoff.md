...
最終更新: 2026-06-17（Apify 7日正式判定=施策後窓6/11〜6/17で月$9.60＝ベースライン$9.50横ばい合格 / Buzz full=top20_retention95%・overlap100%で正常 / Gemini 100%Flash維持 / 残監視2点クリア＝legal_rss_count7・must_follow_count92）
...
- **Apify 7日正式判定 ✅ 合格**: 施策後窓 6/11〜6/17 平均 **月換算$9.60**＝ベースライン$9.50と横ばい。
  （※朝の$11.17は窓に施策前6/10＝$0.77を混入させた集計ミス。訂正済み）。日々の振れは Buzz full日(+$0.18〜0.22)が正体で回帰なし。
