...
def _run_main(args, config: dict, logger, t0: float) -> None:
    ...
    stats = {
        ...
        "legal_feeds_total": x_meta.get("legal_feeds_total", 0),
        "legal_feeds_ok": x_meta.get("legal_feeds_ok", 0),
        "legal_feeds_failed": x_meta.get("legal_feeds_failed", 0),
    ...
    log_run(
        ...
        extra={
            ...
            "legal_feeds_total": stats["legal_feeds_total"],
            "legal_feeds_ok": stats["legal_feeds_ok"],
            "legal_feeds_failed": stats["legal_feeds_failed"],
