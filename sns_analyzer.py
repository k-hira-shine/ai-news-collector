...
- 長文スレッド・deep dive・framework・playbook・lessons learned など、具体的な手順や考え方が体系化された投稿

## 優先順位
同じテーマなら、以下を優先して is_valuable: true にする：
- 短い格言・抽象論より、具体例・手順・失敗談・チェックリストを含む長文投稿
- 海外の creator / solopreneur / indie hacker / personal brand / audience growth 系の成功者による知見
- 1つの主張だけでなく、複数の学び・フレームワーク・再現可能な考え方が含まれる投稿
